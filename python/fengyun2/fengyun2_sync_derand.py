...
class fengyun2_sync_derand(gr.hier_block2):
    def __init__(self, threshold=7):
        ...
        self.pdu_hash_analyzer_0 = fengyun2.pdu_hash_analyzer()
        ...
        self.msg_connect((self.fengyun2_frames_collector_0, 'out'), (self.pdu_hash_analyzer_0, 'in'))
        ...
        self.msg_connect((self.pdu_hash_analyzer_0, 'out'), (self.fengyun2_relevance_check_0, 'in'))
